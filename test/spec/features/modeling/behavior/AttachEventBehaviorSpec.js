  ...
  describe('basics', function() {
    ...
    describe('create', function() {
      ...
      it('should NOT replace', inject(function(elementFactory, elementRegistry, modeling) {
        ...
        // when
        intermediateEvent = modeling.createShape(intermediateEvent, { x: 300, y: 240 }, process);
      ...
      it('should copy properties when attached', inject(function(canvas, elementRegistry, elementFactory, modeling) {
